#demo of SQL SEER database use via RSQLite
# NOTICE: you must
...
pops=dbGetQuery(con, "SELECT * from pops where popyear>2000")
head(pops)
d=dbGetQuery(con, "SELECT * from lymyleuk where histo2=9863 and numprims=1")
